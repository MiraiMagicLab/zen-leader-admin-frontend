...
const chartData = [
  { month: 'T1', value: 4000, growth: 12, color: 'bg-blue-500' },
  { month: 'T2', value: 3000, growth: -8, color: 'bg-red-500' },
  { month: 'T3', value: 5000, growth: 25, color: 'bg-green-500' },
  { month: 'T4', value: 4500, growth: 15, color: 'bg-yellow-500' },
  { month: 'T5', value: 6000, growth: 33, color: 'bg-purple-500' },
  { month: 'T6', value: 5500, growth: 22, color: 'bg-cyan-500' },
];
              ...
              >
                <div className="border-border bg-popover absolute -top-16 left-1/2 z-10 -translate-x-1/2 transform rounded-lg border px-3 py-2 text-sm whitespace-nowrap opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
                  <div className="font-medium">
                    {(item.value * 1_000_000).toLocaleString('vi-VN')} ₫
                  </div>
                  <div
